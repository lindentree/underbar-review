  ...
  describe('Part I', function() {
    ...
    describe('indexOf', function() {
      ...
      it('returns the first index that the target can be found at when there are multiple matches', function() {
        ...
        expect(_.indexOf(numbers, 4)).to.equal(3);
      });
    });
    ...
    describe('reject', function() {
      ...
      it('should produce a brand new array instead of modifying the input array', function() {
        ...
        expect(evens).to.not.eql(numbers);
      });
    });
    ...
    describe('uniq', function() {
      ...
      it('should handle iterators that work with a sorted array', function() {
        var iterator = function(value) { return value === 1; }; //return a boolean
        var numbers = [1, 2, 2, 3, 4, 4]; //[true, false, false, false, false...]

        expect(_.uniq(numbers, iterator)).to.eql([1, 2]); //[true, false]
      });
